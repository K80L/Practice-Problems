...
class MinMaxStack {
  ...
  push(val) {
      ...
      // if minValue array is empty OR new nodes value is lower than smallest value in array, 
      // add the new element as the smallest number in the array at the end
